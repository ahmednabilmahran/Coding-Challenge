...
class AppColors {
  ...
  MaterialColor primarySwatchColor = const MaterialColor(
    ...
    <int, Color>{
      50: Color(0XFF3556AB),
      100: Color(0XFF3556AB),
      200: Color(0XFF3556AB),
      300: Color(0XFF3556AB),
      400: Color(0XFF3556AB),
      500: Color(0XFF3556AB),
      600: Color(0XFF3556AB),
      700: Color(0XFF3556AB),
      800: Color(0XFF3556AB),
      900: Color(0XFF3556AB),
    },
  );
  ...
  Color primaryBlue = const Color(0XFF3556AB);
